...
public class Firstgrade extends javax.swing.JFrame {
      ...
      try{
          ...
          if(frs==frres && second==secres && third==treeres && fourth==fourres){
              ...
              JOptionPane.showMessageDialog(null,"Answer is not correct","alert",JOptionPane.PLAIN_MESSAGE);
                if(frs!=frres){
                    inputFirst.setBackground(new java.awt.Color(255, 51, 51));

           
                 }else{
                    inputFirst.setBackground(new java.awt.Color(0, 255, 0));

                }
                if( second!=secres){
                    inputSecond.setBackground(new java.awt.Color(255, 51, 51));

           
                 }else{
                    inputSecond.setBackground(new java.awt.Color(0, 255, 0));
    ...
    private void resultsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resultsMouseClicked
          ...
          inputFirst.setBackground(new java.awt.Color(255, 255, 204));
            
          inputSecond.setText(String.valueOf(secres));
           inputSecond.setBackground(new java.awt.Color(255, 255, 204));
